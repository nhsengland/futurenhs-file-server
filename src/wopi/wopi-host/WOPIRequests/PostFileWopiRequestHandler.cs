...
namespace FutureNHS.WOPIHost.WOPIRequests
{
        ...
        : WopiRequestHandler
    {
        ...
        private PostFileWopiRequestHandler(string fileId, string accessToken)
        ...
        internal static PostFileWopiRequestHandler With(string fileId, string accessToken) => new PostFileWopiRequestHandler(fileId, accessToken);
